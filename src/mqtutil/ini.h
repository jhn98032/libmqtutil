...
public:
    ...
    typedef enum {TYPE_BYTE_ARRAY, TYPE_SIZE, TYPE_STRING, TYPE_FLOAT, TYPE_INT, TYPE_INT64, TYPE_COLOR} EntryType;
...
public:
    ...
    void setInt64(QString name, int64_t value);
    ...
    int64_t getInt64(QString name, int64_t defaultValue = -1);
    ...
    int getEntryCount(QString path);
